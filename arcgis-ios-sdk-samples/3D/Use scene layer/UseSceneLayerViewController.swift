...
class UseSceneLayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        (self.navigationItem.rightBarButtonItem as! SourceCodeBarButtonItem).filenames = ["UseSceneLayerViewController"]
        ...
        //scene layer
        let sceneLayer = AGSArcGISSceneLayer(URL: NSURL(string: "https://scene.arcgis.com/arcgis/rest/services/Hosted/Building_Hamburg/SceneServer/layers/0")!)
